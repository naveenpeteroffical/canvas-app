...
const Canvas: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (canvas) {
            ...
            if (context) {
                ...
                // Draw all tables
                drawTable(); // Ensure this is called to render the tables
            }
        }
    ...
    const handleMouseMove = (e: React.MouseEvent<HTMLCanvasElement>) => {
        ...
        if (draggingTable) newCursor = 'move';  // Change cursor when dragging a table
        if (shape) {
            isHovering = true;
            newCursor = getResizeCursor(x, y, shape); // Determine resize cursor based on position
        }
        ...
        if (tableUnderMouse) {
            ...
            setCursor('default'); // Reset cursor
        }
                ...
                <div className='w-full'>
                    ...
                    <div className="flex space-x-4">
                        ...
                        <input
                            ...
                            className="p-2 border rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                        <button onClick={() => addTable(numRows, numCols)} className="btn btn-primary">
                            Add Table
                        </button>
                    </div>
